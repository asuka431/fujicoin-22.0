Baricoin version 0.5.4 is now available for download at:
...
Fix Baricoin-Qt notifications under Growl 1.3.
Increase required age of Baricoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBaricoin properly when installing Baricoin-Qt over it. (Windows)
