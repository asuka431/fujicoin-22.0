...
- #17910 Remove double `LIBBARICOIN_SERVER` linking (fanquake)
...
- #18429 Remove double `LIBBARICOIN_SERVER` from bench-Makefile (brakmic)
...
- #18341 Replace remaining literal BARI with `CURRENCY_UNIT` (domob1812)
