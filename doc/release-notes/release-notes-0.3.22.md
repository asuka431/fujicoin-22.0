...
Notable changes:
* Client will accept and relay TX's with 0.0005 BARI fee schedule (users still pay 0.01 BARI per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #baricoin00 - #baricoin99
