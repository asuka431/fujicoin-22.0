...
First, in terms of structure, there is no particular concept of "Baricoin Core
...
Before you start contributing, familiarize yourself with the Baricoin Core build
system and tests. Refer to the documentation in the repository on how to build
Baricoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Baricoin Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
For all other issues and pull requests, the https://github.com/baricoin/baricoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to baricoin-qt
...
fork of Baricoin Core copies the merge. Instead, make any username mentions in a
