...
#ifndef BARICOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BARICOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BARICOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
