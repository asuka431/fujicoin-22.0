...
#ifndef BARICOIN_INTERFACES_INIT_H
#define BARICOIN_INTERFACES_INIT_H
...
//! (baricoin-gui, baricoin-node, baricoin-wallet, baricoind, baricoin-qt) and each
...
#endif // BARICOIN_INTERFACES_INIT_H
