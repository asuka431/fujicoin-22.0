...
# Copyright (c) 2010-2020 The Baricoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test objects for interacting with a baricoind node over the p2p protocol.

The P2PInterface objects interact with the baricoind nodes under test using the
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for Baricoin Node with id: {}'.format(connect_id))
