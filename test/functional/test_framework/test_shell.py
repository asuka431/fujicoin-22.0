...
class TestShell:
    """Wrapper Class for BaricoinTestFramework.

    The TestShell class extends the BaricoinTestFramework
    ...
    class __TestShell(BaricoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BaricoinTestFramework child class.
            self.num_nodes = 1
