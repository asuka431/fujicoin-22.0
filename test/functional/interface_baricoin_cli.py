...
# The block reward of coinbaseoutput.nValue (50) BARI/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BARI/block.
...
class TestBaricoinCli(BaricoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and baricoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 BARI) to the default wallet.
            ...
            # Test baricoin-cli -generate with -rpcwallet in multiwallet mode.
