...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the BaricoinTestFramework, place overrides for the
...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to `True` to
  ...
  mature block subsidies (25x50=1250 BARI) in its wallet. Using them is much more
...
Taken from the [python-baricoinrpc repository](https://github.com/jgarzik/python-baricoinrpc).
...
Test objects for interacting with a baricoind node over the p2p interface.
